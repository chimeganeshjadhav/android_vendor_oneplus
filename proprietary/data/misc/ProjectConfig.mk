...
CUSTOM_HAL_ANT = mt6877_ant_m1
CUSTOM_HAL_AUDIOFLINGER = audio
CUSTOM_HAL_CAMERA = camera
CUSTOM_HAL_CAM_CAL = BRCB032GWZ_3 GT24c32a cat24c16
CUSTOM_HAL_COMBO = mt6877
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR =ov64b_mipi_raw imx355_mipi_raw imx615_mipi_raw ov02b10_mipi_raw imx581_mipi_raw imx471_mipi_raw imx471_mipi_raw21851 gc02m1b_mipi_mono gc02m1_mipi_raw gc02m1_mipi_raw212a1
CUSTOM_HAL_MAIN2_IMGSENSOR = imx355_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = ov64b_mipi_raw
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = imx615_mipi_raw
...
#Xuemeng.Ma@PSW.BSP.Sensor 2020/8/4 add for fusion sensor
...
#Xuemeng.Ma@BSP.Sensor 2021/9/7, add for ai_shutter support
CUSTOM_KERNEL_AI_SHUTTER = yes
#Chendai.Liang@BSP.Sensor 2021/5/7, add for raw_mag support
CUSTOM_KERNEL_RAW_MAG_SENSOR = yes
CUSTOM_KERNEL_GYROSCOPE = yes
CUSTOM_KERNEL_IMGSENSOR =ov64b_mipi_raw imx355_mipi_raw imx615_mipi_raw ov02b10_mipi_raw imx581_mipi_raw imx471_mipi_raw imx471_mipi_raw21851 gc02m1b_mipi_mono gc02m1_mipi_raw gc02m1_mipi_raw212a1
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov64b_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = imx615_mipi_raw
...
#JianBin.Zhang@PSW.MM.Display.LCD.Feature,2021/03/08, Add for enable AOD
#MTK_AOD_SUPPORT = no
#else
MTK_AOD_SUPPORT = yes
#endif
...
MTK_ATF_SUPPORT = yes
MTK_AUDIO = yes
#Jianqing.Liao@HW.AudioDriver,2021/02/07, Enable adsp
...
#Meilin.Zhou@BSP.Security.Basic,2020/09/26,Add for widevine key
...
#liuyun@ANDROID.PERFORMANCE, 2021/3/9, disable MTK duraspeed feature
...
#Qixin.XIANG@NETWORK.DATA.454034/1328665, 2020/09/27, add for open mtk gwsd
...
#An.Wu@Cam.2020/11/12,add for open P3 color space
...
#ifdef OPLUS_FEATURE_VOICE_WAKEUP
...
#endif /* OPLUS_FEATURE_VOICE_WAKEUP */
MTK_AUDIO_A2DP_LATENCY_IMPROVE = yes
MTK_A2DP_OFFLOAD_SUPPORT = yes
MTK_CAM_AINR_SUPPORT = 1
#ifdef OPLUS_FEATURE_CHG_BASIC
#Hailong.Shen@BSP.CHG.Basic, 2021/03/06, Modify for remove mtk vibr hal
OPLUS_LMVIBRATOR_SUPPORT = yes
#Hang.Zhao@BSP.CHG.Basic, 2021/04/13, Modify for tfa98xx ftm vibrator test
OPLUS_TFA98XX_SUPPORT = yes
#Hailong.Shen@BSP.CHG.Basic, 2021/03/16, Modify DRIVER.ISO instead of iAmCdRom.iso
MTK_BICR_SUPPORT = yes
#endif /* OPLUS_FEATURE_CHG_BASIC */
#ifdef OPLUS_DYNAMIC_SINGLE_SIM
#HEZELIN@NETWORK.REG.355129,add for single card ss/dsds files copy.
OPLUS_DEVICE_DYNAMIC_SIM = yes
#endif /*OPLUS_DYNAMIC_SINGLE_SIM*/
